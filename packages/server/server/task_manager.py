...
class _TaskProgressCallback:
    ...
    def on_step(self, info) -> None:
        ...
        if info.status == "progress" and info.detail.get("agent_name"):
...
class TaskManager:
    ...
    def _run_interactive_article(
        ...
        pipeline_input = PipelineInput(
            ...
            story_model=default_cfg.story_model,
            scene_model=default_cfg.scene_model,
            gate_model=default_cfg.gate_model,
            judge_model=default_cfg.judge_model,
